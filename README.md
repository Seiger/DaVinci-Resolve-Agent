...
Субтитри додаються перед відео; довгі рендери можуть затримувати підтвердження.
Роботу із закритою консоллю ще не підтверджено. Міст не замінює весь основний MCP-сервер.
