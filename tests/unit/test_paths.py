...
from agent.paths import (
    ...
    take_sequence_renders_directory,
...
def test_runtime_paths_do_not_contain_a_hardcoded_user_name() -> None:
    ...
    assert take_sequence_media_imports_directory(first_environment) == (
        first_runtime / "take-sequence-media-imports"
    )
    ...
    assert take_sequence_renders_directory(first_environment) == (
        first_runtime / "take-sequence-renders"
    )
